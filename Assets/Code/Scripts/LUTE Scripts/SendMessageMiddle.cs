...
[OrderInfo("AgesOfAvebury",
              "Send Message Middle",
              "Sends a message to the Middle Ages UI")]
[AddComponentMenu("")]
public class SendMessageMiddle : Order
{
    ...
    public override void OnEnter()
    {
        ...
        GameObject content = InitialiseEverything._inboxMiddleCanvas.transform.Find("Scroll View/Viewport/Content").gameObject;
        ...
        messageObject.transform.Find("MsgBG/ContentsField").GetComponent<TMPro.TextMeshProUGUI>().text = message;
 ...
 //you can use this to return a summary of the order which is displayed in the inspector of the order
      return "This order will send a message to the UI with the following details: " + from + " " + message;
    }
}